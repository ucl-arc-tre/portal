...
export type UserTrainingUpdateBody = {
    kind: TrainingKind;
    /**
...
export type UserTrainingResponse = {
    ...
    /**
     * Time in RFC3339 format at which the certificate was issued
     */
...
export type GetAllConfirmedAgreementsData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/agreements';
...
export type GetAllConfirmedAgreementsErrors = {
    /**
     * Internal server error
     */
    500: unknown;
...
export type GetAllConfirmedAgreementsResponses = {
    200: AgreementsList;
};

export type GetAllConfirmedAgreementsResponse = GetAllConfirmedAgreementsResponses[keyof GetAllConfirmedAgreementsResponses];
...
export type ConfirmAgreementErrors = {
    /**
     * Internal server error
     */
    500: unknown;
...
export type ConfirmAgreementResponses = {
    200: AgreementsList;
};

export type ConfirmAgreementResponse = ConfirmAgreementResponses[keyof ConfirmAgreementResponses];

export type GetAgreementsTextApprovedResearcherData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetAgreementsTextApprovedResearcherErrors = {
    /**
     * Not acceptable
     */
    406: unknown;
...
export type GetAgreementsTextApprovedResearcherResponses = {
    200: Agreement;
};

export type GetAgreementsTextApprovedResearcherResponse = GetAgreementsTextApprovedResearcherResponses[keyof GetAgreementsTextApprovedResearcherResponses];

export type ImportApprovedResearchersCsvData = {
    body: Blob | File;
    path?: never;
    query?: never;
...
export type ImportApprovedResearchersCsvErrors = {
    /**
     * Forbidden
     */
    403: unknown;
...
export type ImportApprovedResearchersCsvResponses = {
    /**
     * OK
     */
    204: void;
...
export type ImportApprovedResearchersCsvResponse = ImportApprovedResearchersCsvResponses[keyof ImportApprovedResearchersCsvResponses];
