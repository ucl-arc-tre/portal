...
export type NotificationKind = 'complete-profile' | 'pending-study' | 'asset-expiry' | 'contract-expiry' | 'training-expiry' | 'iaa-assignment' | 'study-affirmation' | 'study-review';
