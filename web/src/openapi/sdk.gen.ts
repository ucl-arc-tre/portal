 ...
 */
export const getTokensDsh = <ThrowOnError extends boolean = false>(options?: Options<GetTokensDshData, ThrowOnError>) => (options?.client ?? client).get<GetTokensDshResponses, unknown, ThrowOnError>({ url: '/tokens/dsh', ...options });
 ...
 */
export const deleteTokensDshByTokenId = <ThrowOnError extends boolean = false>(options: Options<DeleteTokensDshByTokenIdData, ThrowOnError>) => (options.client ?? client).delete<unknown, unknown, ThrowOnError>({ url: '/tokens/dsh/{tokenId}', ...options });
