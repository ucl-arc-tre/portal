...
import type { GetAuthData, GetAuthResponses, GetAuthErrors, GetUserIdentityData, GetUserIdentityResponses, GetUserIdentityErrors, PostUserIdentityData, PostUserIdentityResponses, PostUserIdentityErrors, GetProfileAgreementsData, GetProfileAgreementsResponses, GetProfileAgreementsErrors, PostProfileAgreementsData, PostProfileAgreementsResponses, PostProfileAgreementsErrors, GetProfileTrainingData, GetProfileTrainingResponses, GetProfileTrainingErrors, PostProfileTrainingData, PostProfileTrainingResponses, PostProfileTrainingErrors, GetAgreementsApprovedResearcherData, GetAgreementsApprovedResearcherResponses, GetAgreementsApprovedResearcherErrors, GetAllUsersData, GetAllUsersResponses, GetAllUsersErrors, UpdateUserTrainingDateData, UpdateUserTrainingDateResponses, UpdateUserTrainingDateErrors, PostPeopleApprovedResearchersImportCsvData, PostPeopleApprovedResearchersImportCsvResponses, PostPeopleApprovedResearchersImportCsvErrors } from './types.gen';
 ...
 */
export const postUserIdentity = <ThrowOnError extends boolean = false>(options: Options<PostUserIdentityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostUserIdentityResponses, PostUserIdentityErrors, ThrowOnError>({
        url: '/user/identity',
        ...options,
        headers: {
