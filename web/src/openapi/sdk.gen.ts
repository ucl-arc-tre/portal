 ...
 */
export const getStudiesByStudyIdAssetsByAssetId = <ThrowOnError extends boolean = false>(options: Options<GetStudiesByStudyIdAssetsByAssetIdData, ThrowOnError>) => (options.client ?? client).get<GetStudiesByStudyIdAssetsByAssetIdResponses, unknown, ThrowOnError>({ url: '/studies/{studyId}/assets/{assetId}', ...options });

/**
 * Update an existing asset within a study
 */
export const putStudiesByStudyIdAssetsByAssetId = <ThrowOnError extends boolean = false>(options: Options<PutStudiesByStudyIdAssetsByAssetIdData, ThrowOnError>) => (options.client ?? client).put<PutStudiesByStudyIdAssetsByAssetIdResponses, unknown, ThrowOnError>({
