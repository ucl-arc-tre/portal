...
/**
 * Update another user's chosen name (admin only)
 */
export const putProfile = <ThrowOnError extends boolean = false>(options: Options<PutProfileData, ThrowOnError>) => {
...
/**
 * Request a change to the user's chosen name
 */
export const postProfileChosenNameChangeRequest = <ThrowOnError extends boolean = false>(options: Options<PostProfileChosenNameChangeRequestData, ThrowOnError>) => {
    return (options.client ?? client).post<PostProfileChosenNameChangeRequestResponses, PostProfileChosenNameChangeRequestErrors, ThrowOnError>({
