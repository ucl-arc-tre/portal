...
/**
 * Get all studies pending approval
 */
export const getStudiesPending = <ThrowOnError extends boolean = false>(options?: Options<GetStudiesPendingData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetStudiesPendingResponses, GetStudiesPendingErrors, ThrowOnError>({
        url: '/studies/pending',
        ...options
    });
};
 ...
 */
export const postStudiesByStudyId = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostStudiesByStudyIdResponses, PostStudiesByStudyIdErrors, ThrowOnError>({
        url: '/studies/{studyId}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const postStudiesByStudyIdReview = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdReviewData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostStudiesByStudyIdReviewResponses, PostStudiesByStudyIdReviewErrors, ThrowOnError>({
...
export const getStudiesByStudyIdAssetsByAssetIdContracts = <ThrowOnError extends boolean = false>(options: Options<GetStudiesByStudyIdAssetsByAssetIdContractsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetStudiesByStudyIdAssetsByAssetIdContractsResponses, GetStudiesByStudyIdAssetsByAssetIdContractsErrors, ThrowOnError>({
...
export const postStudiesByStudyIdAssetsByAssetIdContractsUpload = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdAssetsByAssetIdContractsUploadData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostStudiesByStudyIdAssetsByAssetIdContractsUploadResponses, PostStudiesByStudyIdAssetsByAssetIdContractsUploadErrors, ThrowOnError>({
...
export const putStudiesByStudyIdAssetsByAssetIdContractsByContractId = <ThrowOnError extends boolean = false>(options: Options<PutStudiesByStudyIdAssetsByAssetIdContractsByContractIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutStudiesByStudyIdAssetsByAssetIdContractsByContractIdResponses, PutStudiesByStudyIdAssetsByAssetIdContractsByContractIdErrors, ThrowOnError>({
        ...formDataBodySerializer,
