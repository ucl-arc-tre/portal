...
import type { GetAuthData, GetAuthResponses, GetAuthErrors, GetProfileData, GetProfileResponses, GetProfileErrors, PostProfileData, PostProfileResponses, PostProfileErrors, GetProfileAgreementsData, GetProfileAgreementsResponses, GetProfileAgreementsErrors, PostProfileAgreementsData, PostProfileAgreementsResponses, PostProfileAgreementsErrors, PostProfileTrainingData, PostProfileTrainingResponses, PostProfileTrainingErrors, GetAgreementsApprovedResearcherData, GetAgreementsApprovedResearcherResponses, GetAgreementsApprovedResearcherErrors, GetPeopleData, GetPeopleResponses, GetPeopleErrors, PostPeopleUpdateData, PostPeopleUpdateResponses, PostPeopleUpdateErrors } from './types.gen';
 ...
 * Update the agreements for a user
 */
export const postPeopleUpdate = <ThrowOnError extends boolean = false>(options: Options<PostPeopleUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostPeopleUpdateResponses, PostPeopleUpdateErrors, ThrowOnError>({
        url: '/people/update',
        ...options,
        headers: {
            'Content-Type': 'application/json',
