 ...
 */
export const getStudyByStudyId = <ThrowOnError extends boolean = false>(options: Options<GetStudyByStudyIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetStudyByStudyIdResponses, GetStudyByStudyIdErrors, ThrowOnError>({
        url: '/study/{studyId}',
        ...options
    });
};
