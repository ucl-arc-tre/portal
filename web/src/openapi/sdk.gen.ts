 ...
 * Update study status
 */
export const postStudiesByStudyIdStatus = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdStatusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostStudiesByStudyIdStatusResponses, PostStudiesByStudyIdStatusErrors, ThrowOnError>({
...
/**
 * Update study feedback
 */
export const postStudiesByStudyIdFeedback = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdFeedbackData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostStudiesByStudyIdFeedbackResponses, PostStudiesByStudyIdFeedbackErrors, ThrowOnError>({
