 ...
 */
export const postStudiesAdminImport = <ThrowOnError extends boolean = false>(options: Options<PostStudiesAdminImportData, ThrowOnError>) => (options.client ?? client).post<PostStudiesAdminImportResponses, unknown, ThrowOnError>({
 ...
 */
export const postStudiesAdminByStudyIdAssetsImport = <ThrowOnError extends boolean = false>(options: Options<PostStudiesAdminByStudyIdAssetsImportData, ThrowOnError>) => (options.client ?? client).post<PostStudiesAdminByStudyIdAssetsImportResponses, unknown, ThrowOnError>({
 ...
 */
export const postStudiesAdminByStudyIdContractsImport = <ThrowOnError extends boolean = false>(options: Options<PostStudiesAdminByStudyIdContractsImportData, ThrowOnError>) => (options.client ?? client).post<PostStudiesAdminByStudyIdContractsImportResponses, unknown, ThrowOnError>({
 ...
 */
export const postStudiesByStudyIdSignoff = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdSignoffData, ThrowOnError>) => (options.client ?? client).post<PostStudiesByStudyIdSignoffResponses, PostStudiesByStudyIdSignoffErrors, ThrowOnError>({ url: '/studies/{studyId}/signoff', ...options });
 ...
 */
export const deleteProjectsTreByProjectId = <ThrowOnError extends boolean = false>(options: Options<DeleteProjectsTreByProjectIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteProjectsTreByProjectIdResponses, DeleteProjectsTreByProjectIdErrors, ThrowOnError>({ url: '/projects/tre/{projectId}', ...options });
 ...
 */
export const putStudiesByStudyIdAssetsByAssetId = <ThrowOnError extends boolean = false>(options: Options<PutStudiesByStudyIdAssetsByAssetIdData, ThrowOnError>) => (options.client ?? client).put<PutStudiesByStudyIdAssetsByAssetIdResponses, PutStudiesByStudyIdAssetsByAssetIdErrors, ThrowOnError>({
 ...
 * Create a contract
 */
export const postStudiesByStudyIdContracts = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdContractsData, ThrowOnError>) => (options.client ?? client).post<PostStudiesByStudyIdContractsResponses, PostStudiesByStudyIdContractsErrors, ThrowOnError>({
 ...
 * Delete a contract
 */
export const deleteStudiesByStudyIdContractsByContractId = <ThrowOnError extends boolean = false>(options: Options<DeleteStudiesByStudyIdContractsByContractIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteStudiesByStudyIdContractsByContractIdResponses, DeleteStudiesByStudyIdContractsByContractIdErrors, ThrowOnError>({ url: '/studies/{studyId}/contracts/{contractId}', ...options });

/**
 * Get a contract
 */
export const getStudiesByStudyIdContractsByContractId = <ThrowOnError extends boolean = false>(options: Options<GetStudiesByStudyIdContractsByContractIdData, ThrowOnError>) => (options.client ?? client).get<GetStudiesByStudyIdContractsByContractIdResponses, unknown, ThrowOnError>({ url: '/studies/{studyId}/contracts/{contractId}', ...options });
 ...
 */
export const postStudiesByStudyIdContractsByContractIdObjects = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdContractsByContractIdObjectsData, ThrowOnError>) => (options.client ?? client).post<PostStudiesByStudyIdContractsByContractIdObjectsResponses, PostStudiesByStudyIdContractsByContractIdObjectsErrors, ThrowOnError>({
 ...
 */
export const deleteStudiesByStudyIdContractsByContractIdObjectsByContractObjectId = <ThrowOnError extends boolean = false>(options: Options<DeleteStudiesByStudyIdContractsByContractIdObjectsByContractObjectIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteStudiesByStudyIdContractsByContractIdObjectsByContractObjectIdResponses, DeleteStudiesByStudyIdContractsByContractIdObjectsByContractObjectIdErrors, ThrowOnError>({ url: '/studies/{studyId}/contracts/{contractId}/objects/{contractObjectId}', ...options });

/**
 * Get a contract object e.g. PDF
 */
export const getStudiesByStudyIdContractsByContractIdObjectsByContractObjectId = <ThrowOnError extends boolean = false>(options: Options<GetStudiesByStudyIdContractsByContractIdObjectsByContractObjectIdData, ThrowOnError>) => (options.client ?? client).get<GetStudiesByStudyIdContractsByContractIdObjectsByContractObjectIdResponses, GetStudiesByStudyIdContractsByContractIdObjectsByContractObjectIdErrors, ThrowOnError>({ url: '/studies/{studyId}/contracts/{contractId}/objects/{contractObjectId}', ...options });
