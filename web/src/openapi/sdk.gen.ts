...
/**
 * Archive a TRE project (changes status to Archived, makes project read-only)
 */
export const patchProjectsTreByProjectIdArchive = <ThrowOnError extends boolean = false>(options: Options<PatchProjectsTreByProjectIdArchiveData, ThrowOnError>) => (options.client ?? client).patch<PatchProjectsTreByProjectIdArchiveResponses, PatchProjectsTreByProjectIdArchiveErrors, ThrowOnError>({ url: '/projects/tre/{projectId}/archive', ...options });
