...
/**
 * Create a contract object e.g. PDF
 */
 ...
 */
export const postStudiesByStudyIdContractsByContractIdUpload = <ThrowOnError extends boolean = false>(options: Options<PostStudiesByStudyIdContractsByContractIdUploadData, ThrowOnError>) => (options.client ?? client).post<PostStudiesByStudyIdContractsByContractIdUploadResponses, PostStudiesByStudyIdContractsByContractIdUploadErrors, ThrowOnError>({
    bodySerializer: null,
