...
import type { GetProfileData, GetProfileResponse, GetProfileAgreementsData, GetProfileAgreementsResponse, PostProfileAgreementsData, PostProfileAgreementsResponse, PostProfileTrainingNhsdData, PostProfileTrainingNhsdResponse, GetAgreementsApprovedResearcherData, GetAgreementsApprovedResearcherResponse } from './types.gen';
...
/**
 * Update the NHS digital training record for a user
 */
export const postProfileTrainingNhsd = <ThrowOnError extends boolean = false>(options: Options<PostProfileTrainingNhsdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostProfileTrainingNhsdResponse, unknown, ThrowOnError>({
