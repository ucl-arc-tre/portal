...
/**
 * Archive a DSH project (changes status to Archived, makes project read-only)
 */
export const patchProjectsDshByProjectIdArchive = <ThrowOnError extends boolean = false>(options: Options<PatchProjectsDshByProjectIdArchiveData, ThrowOnError>) => (options.client ?? client).patch<PatchProjectsDshByProjectIdArchiveResponses, PatchProjectsDshByProjectIdArchiveErrors, ThrowOnError>({ url: '/projects/dsh/{projectId}/archive', ...options });
