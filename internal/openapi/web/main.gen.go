...
// Valid indicates whether the value is a known member of the AgreementType enum.
...
// Valid indicates whether the value is a known member of the AssetClassificationImpact enum.
func (e AssetClassificationImpact) Valid() bool {
	switch e {
	case AssetClassificationImpactConfidential:
		return true
	case AssetClassificationImpactHighlyConfidential:
		return true
	case AssetClassificationImpactPublic:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AssetFormat enum.
func (e AssetFormat) Valid() bool {
	switch e {
	case AssetFormatElectronic:
		return true
	case AssetFormatOther:
		return true
	case AssetFormatPaper:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AssetLegalBasis enum.
func (e AssetLegalBasis) Valid() bool {
	switch e {
	case AssetLegalBasisConsent:
		return true
	case AssetLegalBasisContract:
		return true
	case AssetLegalBasisLegalObligation:
		return true
	case AssetLegalBasisLegitimateInterests:
		return true
	case AssetLegalBasisPublicTask:
		return true
	case AssetLegalBasisVitalInterests:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AssetProtection enum.
func (e AssetProtection) Valid() bool {
	switch e {
	case AssetProtectionAnonymisation:
		return true
	case AssetProtectionIdentifiableLowConfidencePseudonymisation:
		return true
	case AssetProtectionPseudonymisation:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AssetBaseClassificationImpact enum.
func (e AssetBaseClassificationImpact) Valid() bool {
	switch e {
	case AssetBaseClassificationImpactConfidential:
		return true
...
// Valid indicates whether the value is a known member of the AssetBaseFormat enum.
func (e AssetBaseFormat) Valid() bool {
	switch e {
	case AssetBaseFormatElectronic:
		return true
	case AssetBaseFormatOther:
		return true
	case AssetBaseFormatPaper:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AssetBaseLegalBasis enum.
func (e AssetBaseLegalBasis) Valid() bool {
	switch e {
	case AssetBaseLegalBasisConsent:
		return true
	case AssetBaseLegalBasisContract:
		return true
	case AssetBaseLegalBasisLegalObligation:
		return true
	case AssetBaseLegalBasisLegitimateInterests:
		return true
...
// Valid indicates whether the value is a known member of the AssetBaseProtection enum.
func (e AssetBaseProtection) Valid() bool {
	switch e {
	case AssetBaseProtectionAnonymisation:
		return true
	case AssetBaseProtectionIdentifiableLowConfidencePseudonymisation:
		return true
	case AssetBaseProtectionPseudonymisation:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AssetBaseStatus enum.
...
// Valid indicates whether the value is a known member of the AuthRoles enum.
func (e AuthRoles) Valid() bool {
	switch e {
	case AuthRolesAdmin:
		return true
	case AuthRolesApprovedResearcher:
		return true
	case AuthRolesApprovedStaffResearcher:
		return true
	case AuthRolesBase:
		return true
	...
	case AuthRolesIgOpsStaff:
		return true
	case AuthRolesInformationAssetAdministrator:
		return true
	case AuthRolesInformationAssetOwner:
		return true
	case AuthRolesStaff:
		return true
	case AuthRolesTreOpsStaff:
		return true
	default:
		return false
	}
...
func (e NotificationKind) Valid() bool {
	...
	case NotificationKindIaaAssignment:
		return true
	case NotificationKindProjectDeployed:
		return true
	case NotificationKindStudyAffirmation:
		return true
	case NotificationKindStudyOwnerChange:
		return true
...
func (e ProjectTRERoleName) Valid() bool {
	...
	case EgressChecker:
		return true
	case EgressRequester:
		return true
	case Egresser:
		return true
	case Ingresser:
		return true
	case TrustedEgresser:
		return true
	default:
		return false
	}
...
// Contract A contract associated with a study
...
type Study struct {
	...
	// InvolvesEthicsApproval Whether local or other external body Research Ethics Committee approval is involved (seeking/have sought)
...
// StudyRequest Request payload for creating a new study or updating an existing one
...
// PostStudiesAdminStudyIdOwnerApproveJSONRequestBody defines body for PostStudiesAdminStudyIdOwnerApprove for application/json ContentType.
type PostStudiesAdminStudyIdOwnerApproveJSONRequestBody = StudyOwnerUpdate

// PostStudiesAdminStudyIdOwnerRequestJSONRequestBody defines body for PostStudiesAdminStudyIdOwnerRequest for application/json ContentType.
type PostStudiesAdminStudyIdOwnerRequestJSONRequestBody = StudyOwnerUpdate
...
type ServerInterface interface {
	...
	// (POST /studies/admin/{studyId}/owner-approve)
	PostStudiesAdminStudyIdOwnerApprove(c *gin.Context, studyId StudyIdParam)

	// (POST /studies/admin/{studyId}/owner-request)
	PostStudiesAdminStudyIdOwnerRequest(c *gin.Context, studyId StudyIdParam)
...
func (siw *ServerInterfaceWrapper) GetAgreementsAgreementType(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "agreementType", c.Param("agreementType"), &agreementType, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
// PostStudiesAdminStudyIdOwnerApprove operation middleware
func (siw *ServerInterfaceWrapper) PostStudiesAdminStudyIdOwnerApprove(c *gin.Context) {
	...
	siw.Handler.PostStudiesAdminStudyIdOwnerApprove(c, studyId)
}

// PostStudiesAdminStudyIdOwnerRequest operation middleware
func (siw *ServerInterfaceWrapper) PostStudiesAdminStudyIdOwnerRequest(c *gin.Context) {
	...
	siw.Handler.PostStudiesAdminStudyIdOwnerRequest(c, studyId)
}
...
func (siw *ServerInterfaceWrapper) DeleteStudiesStudyIdAssetsAssetId(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "assetId", c.Param("assetId"), &assetId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteStudiesStudyIdContractsContractId(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "contractId", c.Param("contractId"), &contractId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteStudiesStudyIdContractsContractIdObjectsContractObjectId(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "contractObjectId", c.Param("contractObjectId"), &contractObjectId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) PostStudiesStudyIdOwnerRequest(c *gin.Context) {
	...
	siw.Handler.PostStudiesStudyIdOwnerRequest(c, studyId)
}
...
func (siw *ServerInterfaceWrapper) GetTokensEnvironment(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "environment", c.Param("environment"), &environment, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteTokensEnvironmentTokenId(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "tokenId", c.Param("tokenId"), &tokenId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.POST(options.BaseURL+"/studies/admin/:studyId/owner-request", wrapper.PostStudiesAdminStudyIdOwnerRequest)
	router.POST(options.BaseURL+"/studies/admin/:studyId/owner-approve", wrapper.PostStudiesAdminStudyIdOwnerApprove)
