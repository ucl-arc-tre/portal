...
type ServerInterface interface {
	...
	PostStudiesStudyIdContractsUpload(c *gin.Context, studyId StudyIdParam)
...
func (siw *ServerInterfaceWrapper) GetAgreementsAgreementType(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "agreementType", c.Param("agreementType"), &agreementType, runtime.BindStyledParameterOptions{Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteTokensDshTokenId(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "tokenId", c.Param("tokenId"), &tokenId, runtime.BindStyledParameterOptions{Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
