...
| Approved Researcher|                           | - Access to specific Projects<br>                                              | Is an Approved Researcher                          |
| Approved Staff Researcher|                               | - Access to specific Projects<br>- Access to Study creation                                              | Is an Approved Researcher and UCL Staff                         |
| Information asset owner |                               | - Access to specific Projects<br>- Access to Study creation <br>- Can invite externals                                                       | Is an Approved Staff Researcher and has signed one study agreement                        |
