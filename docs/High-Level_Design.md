...
| Approved Researcher       | Accesses Projects in TREs (i.e. projects with sensitive data)                                 | - Access to specific Projects<br>                                                      | Is an Approved Researcher                                          |
...
| IG Ops staff              | Manage Information Governance via Study reviews and approvals, training certification reviews | - Write training data<br>- Write Study status                                          | Is an ARC Info Gov Advisory Team member                            |
| IG admin                  | IG Ops staff and Study edit                                                                   | - Write Study data<br>- Write Study status                                             | Is a senior ARC Info Gov Advisory Team member                      |
...
| DSH Ops staff             | DSH service member, view DSH Project, and role data                                           | - Read DSH Project and Role data<br>- Write DSH Project status                         | Is a UCL DSH service member                                        |
